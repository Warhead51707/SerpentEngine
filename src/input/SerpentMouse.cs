...
namespace SerpentEngine
{
    public class SerpentMouse
    {
     ...
     //   }
        ...
        {
            if( newMouse.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && oldMouse.LeftButton != Microsoft.Xna.Framework.Input.ButtonState.Pressed && newMouse.Position.X >= 0 && newMouse.Position.X <= GraphicsConfig.SCREEN_WIDTH && newMouse.Position.Y >= 0 && newMouse.Position.Y <= GraphicsConfig.SCREEN_HEIGHT)
            {
                return true;
            }
        ...
        {
            if(newMouse.RightButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && oldMouse.RightButton != Microsoft.Xna.Framework.Input.ButtonState.Pressed && newMouse.Position.X >= 0 && newMouse.Position.X <= GraphicsConfig.SCREEN_WIDTH && newMouse.Position.Y >= 0 && newMouse.Position.Y <= GraphicsConfig.SCREEN_HEIGHT)
            {
                return true;
            }
